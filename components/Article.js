...
//Add new article
const addNewArticle = {
  title: `DOMination is what\'s really fun`,
  date: `Feb 24th, 2021`,
  firstParagraph: `Hodor hodor HODOR! Hodor hodor - hodor?`,
  secondParagraph: `Hodor, hodor. Hodor. Hodor, hodor, hodor. Hodor hodor, hodor.`,
  thirdParagraph: `Hodor hodor - hodor... Hodor hodor hodor hodor.`,
};

data.push(addNewArticle);

/*Step 4*/
//Create article element and append element to DOM
